...
with open("/home/scrapeops/intersites-scrape/Spiders/CSS_Selectors/AutoEsporte.json") as f:
    search_terms = json.load(f)

main_url = "https://autoesporte.globo.com/ultimas-noticias/index/feed/pagina-"

site_id = "ab9a6448-3471-491f-9009-d7ec57daba54"

class AutoEsporteSpider(scrapy.Spider):
    name = "AutoEsporte"
    allowed_domains = ["autoesporte.globo.com"]
