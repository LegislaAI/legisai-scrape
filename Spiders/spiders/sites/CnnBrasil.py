...
with open("/home/scrapeops/intersites-scrape/Spiders/CSS_Selectors/CnnBrasil.json") as f:
    search_terms = json.load(f)

main_url = "https://www.cnnbrasil.com.br/politica/pagina/"

site_id = "f1896da4-4f84-42e7-8b92-f8cd5efbd49a"

class CnnBrasilSpider(scrapy.Spider):
    name = "CnnBrasil"
    allowed_domains = ["cnnbrasil.com.br"]
    start_urls = ["https://www.cnnbrasil.com.br/politica/pagina/1/"]
    INCREMENT = 1
    data = []
    ...
    def parse_article(self, response):
        ...
        updated = updated[:10]
        updated = datetime.strftime(datetime.strptime(updated, "%d/%m/%Y"), "%d/%m/%Y")
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CnnBrasilSpider, cls).from_crawler(crawler, *args, **kwargs)
