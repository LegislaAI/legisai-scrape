...
with open("/home/scrapeops/intersites-scrape/Spiders/CSS_Selectors/ValorInveste.json") as f:
    search_terms = json.load(f)

site_id = "516a9060-ac68-4ec2-822f-f38f85662d9e"

class ValorInvesteSpider(scrapy.Spider):
    name = "ValorInveste"
