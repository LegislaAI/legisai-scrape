...
with open("/home/scrapeops/intersites-scrape/Spiders/CSS_Selectors/Uol.json") as f:
    search_terms = json.load(f)

site_id = "5305d3db-9e13-4bf5-80e6-a185960f5797"

class UolSpider(scrapy.Spider):
    name = "Uol"
    allowed_domains = ["economia.uol.com.br"]
    start_urls = ["https://economia.uol.com.br/ultimas/"]
    INCREMENT = 1
    data = []
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(UolSpider, cls).from_crawler(crawler, *args, **kwargs)
