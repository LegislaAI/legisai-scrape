...
with open("/home/scrapeops/intersites-scrape/Spiders/CSS_Selectors/ValorGlobo.json") as f:
    search_terms = json.load(f)

main_url = "https://valor.globo.com/ultimas-noticias/index/feed/pagina-"

site_id = "6ba8be9a-e77f-4fbe-a8df-e11ab2d319d4"

class ValorGloboSpider(scrapy.Spider):
    name = "ValorGlobo"
    allowed_domains = ["valor.globo.com"]
    start_urls = ["https://valor.globo.com/ultimas-noticias/index/feed/pagina-1"]
    INCREMENT = 1
    data = []
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ValorGloboSpider, cls).from_crawler(crawler, *args, **kwargs)
