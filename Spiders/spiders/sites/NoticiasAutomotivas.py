...
with open("/home/scrapeops/intersites-scrape/Spiders/CSS_Selectors/NoticiasAutomotivas.json") as f:
    search_terms = json.load(f)

main_url = "https://www.noticiasautomotivas.com.br/page/"

site_id = "14a236ae-2315-4e6a-a472-1efc1d71e44c"

class NoticiasAutomotivasSpider(scrapy.Spider):
    name = "NoticiasAutomotivas"
    allowed_domains = ["noticiasautomotivas.com.br"]
    start_urls = ["https://www.noticiasautomotivas.com.br/page/1"]
    INCREMENT = 1
    data = []
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(NoticiasAutomotivasSpider, cls).from_crawler(crawler, *args, **kwargs)
