...
with open("/home/scrapeops/intersites-scrape/Spiders/CSS_Selectors/CartaCapital.json") as f:
    search_terms = json.load(f)

main_url = "https://www.cartacapital.com.br/mais-recentes/page/"

site_id = "3fa52fab-ef4d-4021-82fe-0a6a435f27b0"

class CartaCapitalSpider(scrapy.Spider):
    name = "CartaCapital"
    allowed_domains = ["cartacapital.com.br"]
    start_urls = ["https://www.cartacapital.com.br/mais-recentes/"]
    INCREMENT = 1
    data = []
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(CartaCapitalSpider, cls).from_crawler(crawler, *args, **kwargs)
